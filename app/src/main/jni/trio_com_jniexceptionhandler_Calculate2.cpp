...
void exception_handler(int errorCode){
      ...
      //JNU_ThrowByName(env, "java/lang/Exception", "exception from jni: JNI_CRASH...");

      // jump to main function to do exception process
      siglongjmp(JUMP_ANCHOR, 1);
}

//void JNU_ThrowByName(const char *name, const char *msg)
//{
//     // 查找异常类
...
Java_trio_com_jniexceptionhandler_Calculate2_jniDivide(JNIEnv *env, jobject jobj, jint m, jint n) {
  // 注册需要捕获的异常信号
        /*
